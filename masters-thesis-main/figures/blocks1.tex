\begin{tikzpicture}
    ...
    \node[draw, rectangle, minimum width=1.5cm, minimum height=3cm] (rect1) at (0, 0) {$f(x)$};

    % Draw the second rectangle
    \node[draw, rectangle, minimum width=1.5cm, minimum height=3cm] (rect2) at (4, 0) {$h(x)$};
    ...
    \draw[-{Latex}, thick] (rect2.east) -- (7, 0) node[above] {Paine (hPa)};
